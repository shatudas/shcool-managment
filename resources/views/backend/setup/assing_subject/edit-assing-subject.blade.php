    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
         ...
         <!-- /.card-header -->
         <div class="card-body">
          <form method="POST" action="{{ (@$editData)? route('setups.assing.subject.update',$editData[0]->class_id):route('setups.assing.subject.store') }}" id="myForm">
          @csrf
            ...
            <div class="delete_whole_extra_add" id="delete_whole_extra_add">
             ...
             <div class="form-row">
              ...
              <div class="form-group col-md-2">
               ...
               <input type="text" name="full_mark[]" value="{{ $edit->full_mark }}" class="form-control" placeholder="Enter Amount..">
              </div>
              <div class="form-group col-md-2">
               <label for="class">pass Mark</label>
               <input type="text" name="pass_work[]" value="{{ $edit->pass_work }}" class="form-control" placeholder="Enter Amount..">
              </div>
               <div class="form-group col-md-2">
               <label for="class">Subjective Mark</label>
               <input type="text" name="get_work[]" value="{{ $edit->get_work }}" class="form-control" placeholder="Enter Amount..">
              </div>
