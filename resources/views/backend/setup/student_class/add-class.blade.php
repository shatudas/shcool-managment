      ...
      <div class="col-8 ">
        ...
        <div class="card">
         <div class="card-header">
           <h3>
            @if(isset($editData))Edit Student Class
             @else
              Add Student Class
             @endif

             <a href="{{route('setups.student.class.view')}}" class=" btn btn-success btn-sm float-right"> <i class="fa fa-list"></i> Student List</a>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
