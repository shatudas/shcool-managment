    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
         ...
         <!-- /.card-header -->
         <div class="card-body">
          <form method="POST" action="{{ route('fee.amount.update',$editData[0]->fee_category_id) }}" id="myForm">
          @csrf
             ...
             <div class="form-group col-md-5">
              ...
              <select name="class[]" class="form-control">
               ...
               @foreach($classes as $class)
                <option value="{{ $class->id }}" {{ ($edit->class==$class->id)?"selected":"" }}>{{ $class->name }}</option>
               @endforeach
              </select>
             </div>
             <div class="form-group col-md-5">
              <label for="class">amount</label>
              <input type="text" name="amount[]" value="{{ $edit->amount }}" class="form-control" placeholder="Enter Amount..">
             </div>
